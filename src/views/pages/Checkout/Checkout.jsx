              ...
              <div className="nav">
                <div className="">
                  <Link to="/cart" className="checkout-link">
                    Cart <FaGreaterThan className="icon" />
                  </Link>{" "}
                  <span
                    className={`checkout-link ${
                      displayScreen === "shipping" && "link"
                    } `}
                    onClick={() => setdisplayScreen("shipping")}
                  >
                    Shipping <FaGreaterThan className="icon" />
                  </span>
                  <span
                    className={`checkout-link ${
                      displayScreen === "payment" && "link"
                    } `}
                    onClick={() => setdisplayScreen("payment")}
                  >
                    Payment{" "}
                  </span>
                </div>
